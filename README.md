...
Задача этого проекта &mdash; перевести и поддерживать в актуальном состоянии
...
[issue](https://github.com/openbsd-ru/openbsd-ru.github.io/issues).
...
| **[7.6](https://www.openbsd.org/76.html)** |  Хотите перевести? | |
| **[FAQ_Upgrade Guide: 7.5 to 7.6](https://www.openbsd.org/faq/upgrade76.html)** |  Хотите перевести? | |
...
просты &mdash; OpenBSD стремится предоставить код, который может быть
...
HTML-страницы &mdash; точно такая же часть "кода" OpenBSD как и исходники
